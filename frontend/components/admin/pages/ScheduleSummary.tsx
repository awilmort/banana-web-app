...
const ScheduleSummary: React.FC = () => {
  ...
  const GuestNameCell = ({ reservation }: { reservation: Reservation }) => {
    ...
    return (
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
        ...
        <Typography variant="body2" sx={{ fontWeight: arrived ? 600 : 400 }}>
  ...
  return (
      <Container maxWidth="xl" sx={{ py: 4 }}>
        <SectionTitle title={t('admin.schedule.title')} />
          ...
          <Grid size={{ xs: 12, sm: 4 }}>
            <Card sx={{ height: '100%', borderTop: 3, borderColor: 'success.main' }}>
              <CardContent sx={{ textAlign: 'center' }}>
                ...
                <Typography variant="h3" sx={{ fontWeight: 700 }} color="success.main">{totals.arrivedGuests}</Typography>
                <LinearProgress
                  variant="determinate"
          ...
          <Grid size={{ xs: 12, sm: 4 }}>
            <Card sx={{ height: '100%', borderTop: 3, borderColor: 'warning.main' }}>
              <CardContent sx={{ textAlign: 'center' }}>
                ...
                <Typography variant="h3" sx={{ fontWeight: 700 }} color="warning.dark">{totals.pendingGuests}</Typography>
              </CardContent>
            </Card>
          </Grid>
          {/* 3rd — Total People */}
          <Grid size={{ xs: 12, sm: 4 }}>
            <Card sx={{ height: '100%', borderTop: 3, borderColor: 'primary.main' }}>
              <CardContent sx={{ textAlign: 'center' }}>
                ...
                <Typography variant="h3" sx={{ fontWeight: 700 }}>{totals.totalPeople}</Typography>
              </CardContent>
            </Card>
          </Grid>
        </Grid>
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align="right">
                          <Typography variant="body2" sx={{ fontWeight: 500 }}>{getTotalGuests(r)}</Typography>
                        </TableCell>
                      </TableRow>
                    );
                  })}
