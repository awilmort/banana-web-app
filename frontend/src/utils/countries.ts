// Complete list of countries based on ISO 3166-1 alpha-2 standard
// This is a static resource for better performance and maintainability

export interface Country {
  code: string;
  name: string;
  dialCode?: string; // For future use with phone number formatting
}
...
// Most popular countries for resort bookings (for prioritized display)
export const POPULAR_COUNTRIES = [
  'US', 'CA', 'MX', 'GB', 'DE', 'FR', 'IT', 'ES', 'AU', 'JP', 'BR', 'AR'
];
